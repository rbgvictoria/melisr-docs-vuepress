# Specify IPT integration – Part 2

At a meeting of the Specify Collections Consortium Technical Advisory Committee,
...
publication of the Darwin Core Archives.

So, below is the even more impressive query that we use now. The publication of
